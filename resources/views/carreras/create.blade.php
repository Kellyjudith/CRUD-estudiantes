...
@section('content')
    <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-3xl font-bold text-stone-800">➕ Nueva Carrera</h1>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-stone-100 p-8 max-w-2xl">
        <form action="{{ route('carreras.store') }}" method="POST" class="space-y-6">
            ...
            <div class="pt-4">
                <button type="submit" class="bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-xl">Guardar Carrera</button>
            </div>
        </form>
    </div>
@endsection